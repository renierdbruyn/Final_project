zz<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
/**
 * CodeIgniter
 *
...
class CI_Email {
	...
	var	$smtp_host		= "itstudents.dut.ac.za";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "group8@dut.ac.za";		// SMTP Username
	var	$smtp_pass		= "2uVuphEr";		// SMTP Password
