<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	*/ 
	...
	$config['database']['custom']['user_profile']['primary_key'] = 'upro_id';
        $config['database']['custom']['user_profile']['primary_key'] = 'id_number';
	...
	$config['database']['custom']['user_profile']['custom_columns'] = array(
		'upro_first_name','upro_last_name','upro_phone','id_number'
	);
	...
	*/
	...
	$config['sessions']['group'] = 'group';
        $config['sessions']['is_public'] = 'admin';
	$config['sessions']['privileges'] = 'privileges';
        $config['sessions']['id_number'] = 'id_number';
	...
	*/
	$config['cookies']['user_id'] = 'user_id';
        $config['cookies']['id_number'] = 'id_number';
	...
	*/
	$config['cookies']['login_via_password_token'] = 'login_via_password_token';
          $config['cookies']['is_public'] = 'is_public';
          $config['cookies']['id_number'] = 'id_number';
	...
	*/
	$config['security']['recaptcha_public_key']	= '6LcbYeUSAAAAAGUGnGAOv0657idqaIrXIpy1orAD';
	$config['security']['recaptcha_private_key'] = '6LcbYeUSAAAAANgZWJbRVpzVGNY9THhdDUhs_v39'; 
	...
	*/
	...
	$config['email']['site_title'] = "You Choose Recruit";
	
	// Reply email shown as 'from' header on emails.
	$config['email']['reply_email'] = "group8@dut.ac.za";
	...
	*/
	$config['email']['email_template_directory'] = 'layout/email/';
