...
<
				...
				<a href="<?php echo base_url();?>index.php/auth_admin/insert_user_group">Insert New User Group</a>
					...
					<table class="table table-striped">
						...
						<?php foreach ($user_groups as $group) { ?>
							<tr>
								...
								<td class="align_ctr">
									<a href="<?php echo base_url().'index.php/auth_admin/update_group_privileges/'.$group[$this->flexi_auth->db_column('user_group', 'id')];?>">Manage</a>
								</td>
								<td class="align_ctr">
