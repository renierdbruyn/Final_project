			...
			<?php } ?>
				...
				<?php echo form_open(current_url());	?>
					<fieldset>
						...
						<a href="<?php echo base_url(); ?>index.php/auth_admin/manage_user_accounts" class="link_button grey">Reset</a>
					...
					<table>
						...
						<tbody>
							...
							<tr>
								...
								<td class="align_ctr">
									<a href="<?php echo base_url().'index.php/auth_admin/update_user_privileges/'.$user[$this->flexi_auth->db_column('user_acc', 'id')];?>">Manage</a>
								</td>
								<td class="align_ctr">
