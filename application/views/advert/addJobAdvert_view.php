    ...
    <TR ALIGN="CENTER">
      ...
      <p>
          <select data-placeholder="Choose qualification type" multiple="multiple" class="chosen-select-no-results" name ="qualification_name[]" style="width:350px;" tabindex="11">
            �<option value="Advanced Certificate in Education Ã¢â‚¬â€œ ACE">Advanced Certificate in Education Ã¢â‚¬â€œ ACE</option>
            �<option value="National Professional Diploma in Education Ã¢â‚¬â€œ NPDE">National Professional Diploma in Education Ã¢â‚¬â€œ NPDE</option>
            ...
            �<option value="BClinical Medical Practice Ã¢â‚¬â€œ Bachelor of Clinical Medical Practice">BClinical Medical Practice Ã¢â‚¬â€œ Bachelor of Clinical Medical Practice</option>
            �<option value="BCur Ã¢â‚¬â€œ Bachelor of Nursing Science">BCur Ã¢â‚¬â€œ Bachelor of Nursing Science</option>
            �<option value="BCur (I et A) Education and Administration">BCur (I et A) Education and Administration</option>
            �<option value="BDietetics Ã¢â‚¬â€œ Bachelor of Dietetics">BDietetics Ã¢â‚¬â€œ Bachelor of Dietetics</option>
            �<option value="BOccTher Ã¢â‚¬â€œ Bachelor of Occupational Therapy">BOccTher Ã¢â‚¬â€œ Bachelor of Occupational Therapy</option>
            �<option value="BOH Ã¢â‚¬â€œ Bachelor of Oral Hygiene">BOH Ã¢â‚¬â€œ Bachelor of Oral Hygiene</option>
            �<option value="BPhysT Ã¢â‚¬â€œ Bachelor of Physiotherapy">BPhysT Ã¢â‚¬â€œ Bachelor of Physiotherapy</option>
            �<option value="BRad - Bachelor of Radiography">BRad - Bachelor of Radiography</option>
            �<option value="MBChB Ã¢â‚¬â€œ Bachelor of Medicine and Surgery">MBChB Ã¢â‚¬â€œ Bachelor of Medicine and Surgery</option>
            ...
            �<option value="BSc (Four-year programme) Ã¢â‚¬â€œ Biological and Agricultural Sciences">BSc (Four-year programme) Ã¢â‚¬â€œ Biological and Agricultural Sciences</option>
            �<option value="BSc (Four-year programme) Ã¢â‚¬â€œ Mathematical Sciences">BSc (Four-year programme) Ã¢â‚¬â€œ Mathematical Sciences</option>
            �<option value="BSc (Four-year programme) Ã¢â‚¬â€œ Physical Sciences">BSc (Four-year programme) Ã¢â‚¬â€œ Physical Sciences</option>
