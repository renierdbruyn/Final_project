...
class Flexi_auth_lite
{
	...
	{
		return (bool) $this->CI->auth->session_data[$this->CI->auth->session_name['id_number']];
	}
	...
	{
		return (bool) $this->CI->auth->session_data[$this->CI->auth->session_name['is_public']];
	}
	/**
	 * in_group
	...
	{
		return ($this->CI->auth->session_data[$this->CI->auth->session_name['id_number']] !== FALSE) ? 
			$this->CI->auth->session_data[$this->CI->auth->session_name['id_number']] : FALSE;
	}
